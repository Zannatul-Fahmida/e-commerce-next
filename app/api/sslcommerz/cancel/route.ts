...
export async function POST(req: Request) {
  try {
    ...
    console.log("Payment cancelled:", Object.fromEntries(formData));

    if (!tran_id) {
      console.error("Missing tran_id in cancel callback", { tran_id });
    ...
    console.error("Error in cancel handler:", {
